...
exports.FikaIntegrationService = void 0;
const tsyringe_1 = require("C:/snapshot/project/node_modules/tsyringe");
let FikaIntegrationService = class FikaIntegrationService {
    config;
    isFikaActive = false;
    fikaBotIds = new Set();
    constructor(config) {
    ...
    initializeFikaIntegration() {
        if (!this.config.enabled || !this.isFikaActive)
            return;
        try {
    ...
    handlePlayerScavBot(botId, botData) {
        if (!this.config.playerScavHandling || !this.isFikaActive)
            return;
        try {
...
exports.FikaIntegrationService = FikaIntegrationService;
exports.FikaIntegrationService = FikaIntegrationService = __decorate([
